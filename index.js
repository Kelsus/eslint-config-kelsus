...
module.exports = {
  ...
  rules: {
    ...
    //   mentioned by the Kelsus styleguide are listed but commented out (so
    //   they don't override a base ruleset).
    // - Rules that are recommended but contradict the Kelsus styleguide
    //   are explicitely set to the Kelsus styleguide value.
    // Possible Errors
    ...
    // Kelsus's 4-space indent for line continuations.
    // 'jsx-quotes': 0,
    // 'key-spacing': 2,
    // 'keyword-spacing': 2,
